...
/* USB stack memory - must reside in dedicated USB SRAM. The LPC4370 has
 * 32 KB of USB AHB SRAM at 0x20000000; we reserve the first 8 KB for the
 * USBD ROM stack. (Was in bambino's board.h; pulled in-tree here because
 * we don't import bambino's board library.) */
#ifndef USB_STACK_MEM_BASE
